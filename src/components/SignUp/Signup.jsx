                            ...
                            <div className='col-span-6 sm:col-span-3'>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        type="text"
                                        className="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm text-white"
                                        placeholder="Họ"
                                        required
                                    />
                                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    type="password"
                                    className="inputPassword w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm text-white"
